!function() {
    ...
    var   Class                     = require('ee-class')
        ...
        , log                       = require('ee-log')
        , RestrictionSet            = require('./RestrictionSet')
    ...
    module.exports = new Class({
        ...
        init: function(options) {
            ...
            this.restrictionCache = new Cachd({
                ...
                , minFreeMemory : options.minFreeMemory
            });
         ...
         , loadRestrictions: function(restrictionIds, restrictionSet) {
             ...
             return Promise.all(restrictionIds.map(function(id) {
                 return new Promise(function(resolve, reject) {
                     if (this.loaderQueue[id]) this.loaderQueue[id].push(resolve);
                     else {
                          this.loaderQueue[id] = [resolve];

                          return this.db.rowRestirction(['id', 'nullable', 'global', 'column', 'value'], {id: id})
                          ...
                          .then(function(rowRestriction) {
                              ...
                              this.loaderQueue[id].forEach(function(r) {
                                  r();
                              }.bind(this));
