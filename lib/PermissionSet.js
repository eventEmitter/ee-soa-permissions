    ...
    module.exports = new Class({
        ...
        , init: function(permissions, cacheKey) {
            ...
            permissions.forEach(function(permission) {
                ...
                this.roles = this.roles.concat(permission.getRoles());
                ...
                permission.once('delete', function() {
                    ...
                    permission.getRoles().forEach(function(role) {
         ...
         */
        , getRowRestrictions: function(entityName) {
            return this.restrictionSet ? this.restrictionSet.get(entityName) : [];
        }
