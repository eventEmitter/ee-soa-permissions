(function() {
    ...
    module.exports = new Class({
         ...
         */
        , hasApp: function() {
            return this.token ? this.token.isAppToken() : false;
        }
         ...
         */
        , hasTenant: function() {
            return this.token ? this.token.hasTenant() : false;
        }
        ...
        /**
         * returns the tenant for the permisson if exists
         *
         * @returns {object|null} the tenant or null
         */
        , getTenant: function() {
            return this.token ? this.token.getTenant() : null;
        }
        ...
        /**
         * returns the app for the permisson if exists
         *
         * @returns {object|null} the app or null
         */
        , getApp: function() {
            return this.token ? this.token.getApp() : null;
        }
        ...
        , collectPermissionInfo: function(permissions) {
            ...
            // check all roles
            Object.keys(this.roles).some(function(roleName) {
                this.roles[roleName].collectPermissionInfo(permissions);
            }.bind(this));
        }
