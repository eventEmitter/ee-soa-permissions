(function() {
    ...
    module.exports = new Class({
         ...
         */
        , getTenant: function() {
            return this.data.user && this.data.user.tenant ? this.data.user.tenant : (
                this.data.service && this.data.service.tenant ? this.data.service.tenant : (
                    this.data.app && this.data.app.company && this.data.app.company.tenant ? this.data.app.company.tenant : null));
        }
         ...
         */
        , hasTenant: function() {
            return (this.data.user && this.data.user.tenant) || (this.data.service && this.data.service.tenant) || (this.data.app && this.data.app.company && this.data.app.company.tenant);
        }
