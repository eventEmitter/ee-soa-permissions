!function() {
    ...
    module.exports = new Class({
        ...
        /**
         * checks if this token belongs to a user or to a service
         *
         * @returns {boolean} true if this token belongs to a user
         */
         ...
         */
        , getTenant: function() {
            return this.data.user && this.data.user.tenant ? this.data.user.tenant : (this.data.service && this.data.service.tenant ? this.data.service.tenant : null);
        }
         ...
         */
        , hasTenant: function() {
            return this.data.user && this.data.user.tenant || this.data.service && this.data.service.tenant;
        }
