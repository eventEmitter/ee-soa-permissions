!function() {
    ...
    module.exports = new Class({
        ...
        , roleLastUpdated: new Date(1983, 9, 2, 7, 30, 0)
        , capabilityLastUpdated: new Date(1983, 9, 2, 7, 30, 0)
        , permissionLastUpdated: new Date(1983, 9, 2, 7, 30, 0)
        , rowRestrictionLastUpdated: new Date(1983, 9, 2, 7, 30, 0)
        ...
        , getRole: asyncMethod(function(roleName, callback) {
            ...
            if (this.cache.has(roleName)) callback(null, this.cache.get(roleName));
                ...
                if (this.loaderCache[roleName]) this.loaderCache[roleName].push(callback);
                    ...
                    // row restrictions
                    query.getRowRestriction(['column', 'value', 'nullable'])
